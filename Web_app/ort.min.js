...
var ort = (() => {
  ...
  var no = tt((Eb, ka) => {
    ...
    K.create = $a()
    K.prototype._slice = Ct.Array.prototype.subarray || Ct.Array.prototype.slice
            ...
            (e.fromObject = function (t) {
              ...
              if (t.typeProtos) {
                ...
                for (var n = 0; n < t.typeProtos.length; ++n) {
                  ...
                  r.typeProtos[n] = p.onnx.TypeProto.fromObject(t.typeProtos[n])
                }
              }
              return r
            }),
            ...
            (e.verify = function (t) {
              ...
              if (t.input != null && t.hasOwnProperty("input")) {
                ...
                for (var r = 0; r < t.input.length; ++r)
                  if (!h.isString(t.input[r])) return "input: string[] expected"
              }
            ...
            (e.decode = function (t, r) {
              ...
              for (
                ...
                switch (a >>> 3) {
                  ...
                  case 12: {
                    ;(s.output && s.output.length) || (s.output = []),
                      s.output.push(p.onnx.ValueInfoProto.decode(t, t.uint32()))
                    break
                  }
                  case 13: {
            ...
            (e.decode = function (t, r) {
              ...
              for (
                ...
                switch (a >>> 3) {
                  ...
                  case 3: {
                    s.segment = p.onnx.TensorProto.Segment.decode(t, t.uint32())
                    break
                  }
                  case 4: {
                    if (
          ...
          return (
            ...
            (e.decode = function (r, n) {
              ...
              for (
                ...
                switch (u >>> 3) {
                  case 1: {
                    a.tensorType = p.onnx.TypeProto.Tensor.decode(r, r.uint32())
                    break
                  }
                  case 4: {
        ...
        (Vr = class {
          ...
          readTexture(e) {
            return e.isPacked
              ...
              : this.session.textureManager.readUint8TextureAsFloat(fo(this, e))
          }
          ...
          return (
            this.context.programInfo.inputNames.forEach((o, t) => {
              ...
              ;(e[a] = new O(i.indexToOffsetSingle(a, s, n))),
                ...
                (e[a] = new O(i.indexToOffsetSingle(a, s, n.slice().reverse())))
            }),
            e
          )
        }
          ...
          this.profiler.event(
            ...
            () => {
              ...
              try {
                ...
                throw (z.error("ProgramManager", e.programInfo.shaderSource), s)
              }
...
as ORT format: ${n}`)
  ...
  var Uf,
    ...
    Hf = x(() => {
      ...
      tm = zf ? null : (i) => new Worker(i ?? Lt, { type: "classic", name: Uf })
    })
  var Lt,
    em,
    jf,
